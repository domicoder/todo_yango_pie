...
from todo_yango_pie.common import views as common_views
from todo_yango_pie.core import urls as core_urls
...
schema_view = get_schema_view(
    openapi.Info(
        title="todo-yango-pie API",
        default_version="1.0",
        description="todo-yango-pie Docs",
        terms_of_service="https://www.google.com/policies/terms/",
        contact=openapi.Contact(email="support@todo-yango-pie.com"),
