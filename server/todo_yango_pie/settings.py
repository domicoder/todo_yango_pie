...
SERVER_EMAIL = config("DEFAULT_FROM_EMAIL", default="todo-yango-pie <noreply@todo_yango_pie.com>")

DEFAULT_FROM_EMAIL = SERVER_EMAIL

# Email address of the staff who should receive certain emails
STAFF_EMAIL = config("STAFF_EMAIL", default="no-reply@todo-yango-pie.com")

#
# Domain Configuration
#
HEROKU_APP_NAME = config("HEROKU_APP_NAME", default="todo_yango_pie-staging")
...
ROOT_URLCONF = "todo_yango_pie.urls"
...
TEMPLATES = [
    {
        ...
        "DIRS": [
            ...
            os.path.join(BASE_DIR, "todo_yango_pie", "client", "templates"),  # Swagger template override
        ],
...
WSGI_APPLICATION = "todo_yango_pie.wsgi.application"
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PAGINATION_CLASS": "todo_yango_pie.core.pagination.PageNumberPagination",
...
if config("USE_AWS_STORAGE", cast=bool, default=False) and not IS_REVIEW_APP:
    ...
    DEFAULT_FILE_STORAGE = "todo_yango_pie.utils.storages.PrivateMediaStorage"
    # STATICFILES_STORAGE = "todo_yango_pie.utils.storages.StaticRootS3Boto3Storage"
...
ADMINS = [("todo-yango-pie", "support@todo-yango-pie.com")]
...
LOGGING = {
    ...
    "loggers": {
        ...
        "todo_yango_pie.request": {"handlers": [], "level": "INFO", "propagate": True},
        "todo_yango_pie.tasks": {"handlers": [], "level": "INFO", "propagate": True},
    },
}
...
if IN_PROD or ROLLBAR_ACCESS_TOKEN:
    ...
    LOGGING["loggers"]["todo_yango_pie"]["handlers"].append("rollbar")

# Popular testing framework that allows logging to stdout while running unit tests
TEST_RUNNER = "django_nose.NoseTestSuiteRunner"

CORS_ALLOWED_ORIGINS = ["https://todo-yango-pie-staging.herokuapp.com", "https://todo-yango-pie.herokuapp.com"]
