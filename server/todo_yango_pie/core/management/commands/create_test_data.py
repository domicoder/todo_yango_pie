...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        get_user_model().objects.create_superuser(
            email="admin@todo-yango-pie.com", password=superuser_password, first_name="Admin", last_name="todo-yango-pie"
        )
        get_user_model().objects.create_user(
            email="cypress@todo-yango-pie.com", password=cypress_password, first_name="Cypress", last_name="E2E_test"
        )
